...
export function BellIcon({ color = colorValues.grey900, size = 24 }: IconProps) {
  return (
    <Svg fill="none" height={size} viewBox="0 0 24 24" width={size}>
      ...
      <Path
        ...
        fillRule="evenodd"
      />
      <Path d="M14.647 3.68c0 .695-1.396.042-2.5.042s-2.5.653-2.5-.043c0-.695 1-1.679 2.5-1.679s2.5.984 2.5 1.68" fill={color} />
      <Path clipRule="evenodd" d="M10 18a2 2 0 1 0 4 0h2a4 4 0 0 1-8 0z" fill={color} fillRule="evenodd" />
    </Svg>
  );
}
